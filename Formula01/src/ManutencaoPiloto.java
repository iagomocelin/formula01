...
public class ManutencaoPiloto extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ESCOLHA -", "BR", "USA", "PT" }));

        jLabel5.setText("EQUIPE:");

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ESCOLHA -", "FERRARRI", "MERCEDES", "CHEVROLET" }));
